//WAP to calculate the total salary of employe
// Ts = B.S + DA + TA - HRA
/* If Basic salary < 35000 than DA is 2% of BS
                                TA is 3% of BS
                                HRA is 4% of BS
 If basic salary >35000 & < 80000 then DA is 3%
                                   TA is 4%
                                   HRA is 7%
 If Basic salary >80000 then DA is 4%
                             TA is 4%
                             HRA is 9%                                                                 
*/
